...
public class TestUrlLoader : MonoBehaviour {
    ...
    private void OnGUI() {
        ...
        if (GUILayout.Button("Load Model from URL")) {
            ...
            var webRequest = AssetDownloader.CreateWebRequest(string.IsNullOrEmpty(DownloadUrl)
                ? "https://ricardoreis.net/trilib/demos/avatars/003/003_visemes.zip"
                : DownloadUrl);
    ...
    private void OnMaterialsLoad(AssetLoaderContext assetLoaderContext) {
        ...
        myLoadedGameObject.GetComponent<MeshRenderer>().material.SetTexture(BumpMap, null);
    }
}